...
String yourname = "I'm Shivam Thapa,";
...
String miniDescription =
    "Freelancer and a Flutter developer providing services for programming and design content needs. Join me down below and let's get started!";

String servicesSubHeading =
    "Since the beginning of my journey as a Flutter designer and developer, I've worked in startups and collaborated with talented people to create digital products for both business and consumer use. I offer a wide range of services, including brand design, programming and teaching.";
//
...
const String aboutMeHeadline =
    'I\'m Shivam Thapa, a Mobile App developer, Web developer and UI designer.';
